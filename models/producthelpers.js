...
module.exports = {
    ...
    updateProducts: (productId, productDetails, urls) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            db.get().collection(collection.PRODUCT_COLLECTIONS).updateOne({ _id: objectId(productId) }, {
                $set:
                {
    ...
    updatecategory: (categoryId, categoryDetails) => {
        ...
        return new Promise((resolve, reject) => {
            console.log(categoryDetails);
            categoryDetails.name = categoryDetails.name.toUpperCase();
            db.get().collection(collection.CATEGORY_COLLECTIONS).updateOne({ _id: objectId(categoryId) }, {
                $set:
                {
